...
const Skills = ({}: SkillsProps) => {
    return (
        <section
            id="skills"
            className="relative flex h-dvh w-full flex-col justify-center gap-16 bg-red-500 px-6 pt-32 lg:px-16 lg:pt-24 lg:pb-10"
        >
                    ...
                    >
                        ...
                        <div id="skills" className="flex flex-col gap-4">
                            {groupSkills.map((skill) => (
                                <div
                                    key={skill.name}
                                    className="flex w-full justify-between text-2xl"
