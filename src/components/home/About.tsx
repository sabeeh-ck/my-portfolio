...
const About = () => (
    <section id="about" className="flex scroll-mt-20 flex-col gap-3">
        ...
        <p className="text-sm md:text-base">
            Hi, I’m a developer passionate about building sleek, responsive web
            apps. I love turning design ideas into interactive experiences using
            React, Tailwind, and JavaScript. When I’m not coding, you’ll find me
            exploring new tech or tinkering with side projects.
        </p>
